function [LList, LLabels] = MWBL_legend_auto_plot(cset,Sensors,SensorList)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Modified by Tyler Knapp, 02/25/2025 - Adding variables out and removing legend creation
